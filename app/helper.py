...
def add_dummy_data():
    ...
    users = [
        ...
        User(id=4, username='sersangy', email='sersang@thinkmad.com', password_hash='scrypt:32768:8:1$4gfZkeRAEHOn76vs$8345a05fd6bb9a8f5bf2b8bfe1c86cf90bf36530f8c7499608ec0bf89f8f088666936e745ca7ddad74a815ea9f09ff095fa959f67e64d30d9c752282b1f920d2', Thinkpads=1, pronouns='Sher/Her')
    ]

    posts = [
        Post(id=1, title="Just bought my first thinkpad and now looking for more", body="I just bought my first thinkpad and have been having a great time with it. Now I'm looking for more but need advice on what models I should get.", timestamp="", user_id=4),
        Post(id=2, title="X220 keeps overheating", body="I have an X220 and currently the CPU reaches 80 degress while doing almost nothing. Does anyone have any advice?", timestamp="", user_id=2),
        Post(id=3, title="X13 battery life is terrible", body="My new ThinkPad X13 Gen 2 AMD is only one year old however ever since I got it, its battery has only lasted a maximum of two hours. I am not sure if it's something to do with settings or if there is something wrong with the battery itself. I have run Windows, Ubuntu, and Arch on it but the result is the same. Has anyone else had the same experience with this model?", timestamp="", user_id=3)
    ]
